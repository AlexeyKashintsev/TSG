/**
 * 
 * @name BillsBuilder_Interstroy_Sakko
 * @author Alexey
 */
function BillsBuilder_Interstroy_Sakko() {
                   ...
                   /* self.all_dates.forEach(function(day){
                    ...
                    self.chars_flat.forEach(function(flat_char){
                     ...
                     var tableInfo = {
                         SRooms: 153.7,
                         SOverall: 2567.6,
                         ElectricityNorm: 2.85,
                         ElectricityTariff: 3.89,
                         ElectricityCalculation: 0.66,
                         ElectricityCalculationString: 'Pээ = 2,85*153,7*3,89/2567,6 = 0,66 руб/м2',
                         ElectricityResultString: square + ' * 0,66 * 3 = ' + (square*0.66*3).toFixed(2),
                         ColdWaterNorm: 0.0378,
                         ColdWaterTariff: 17.50,
                         ColdWaterCalculation: 0.09,
                         ColdWaterCalculationString: 'Pхв = 0.0378*153,7*17,50/2567,6 = 0,0395 руб/м2',
                         ColdWaterResultString: square + ' * 0,0395 * 3 = ' + (square*0.0395*3).toFixed(2)
                     };

                    var lc_data = { 
                        lc_id:          dsLC_byid.cursor.lc_id,
                        lc_regto:       dsLC_byid.cursor.lc_regto+ ' (Л/c С44' + dsLC_byid.cursor.lc_num + ')',
