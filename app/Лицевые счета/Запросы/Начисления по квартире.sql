...
, t.lc_flat_services_id, t.lc_id, t.services_id, max(t3.usl_order) as usl_order
...
From per_sums t1
 ...
 and t.services_id = t3.services_id and :parAccount = t3.account_id
 Where :flat_id = t.lc_id
 and :date_id = t1.date_id
 and :parAccount = t.account_id
 Group by t1.per_sums_id, t1.flat_service_id, t1.date_id, t1.calc, t1.benefit
, t1.recalc, t1.full_calc, t1.rate, t1.calc_value, t.lc_flat_services_id
, t.lc_id, t.services_id, t.fs_active) q
