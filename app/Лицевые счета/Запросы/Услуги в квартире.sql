 ...
 */ 
select * from (
Select max(t2.grp_services_id) as grp_services_id, t1.lc_flat_services_id, t1.lc_id
...
group by t1.lc_flat_services_id, t1.lc_id
, t1.services_id, t1.fs_active, t1.date_start, t1.date_end
, t1.period_start, t1.period_end) q
