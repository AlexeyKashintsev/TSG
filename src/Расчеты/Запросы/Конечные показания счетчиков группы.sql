 ...
 * @manual 
 */ 
Select t4.lc_id, t4.lc_flat_services_id, t3.end_val AS fm_value
, 'GRP_END_' || t1.cnt_type AS fm_name 
From Calc_object q
 ...
 Inner Join lc_flat_services t4 on q.lc_id = t4.lc_id
 and t4.services_id = t2.services_id
